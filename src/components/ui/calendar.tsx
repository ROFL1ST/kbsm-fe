  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: "h-8 px-2 bg-transparent text-sm border rounded-md border-input shadow-sm focus:ring-1 focus:ring-primary outline-none cursor-pointer hover:bg-accent hover:text-accent-foreground",
        vhidden: "sr-only",
